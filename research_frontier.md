...
Generated 2026-09-19T13:29:10Z at commit `662b627ebe` (tree dirty).

27 registered changes, cumulative hypothesis count 1215, verdicts {'REJECTED': 20, 'INCONCLUSIVE': 6, 'ACCEPTED': 1}.

Sealed holdout: 14 symbols, `examined: False`.

25 progress records across phases phase0-data-integrity, phase0-engineering-audit, phase1-control-hierarchy, phase1-mechanism, phase1-reframe-target, phase1-timeframe-ratio, phase2-falsification, phase2-fresh-market, phase2-pilot, phase2-validation, phase3-fresh-market-batch, phase3-intraday-window.
